...
# ********************************************************
# Нэр: Munkhpurev Naranbaatar
# И-мэйл хаяг: 23b1num0114@stud.num.edu.mn 
# ********************************************************
...
# buh usgiig jijijg useg bolgono
# useg too hooson zainaas busad temdgiig zaigaar solino
# olon hoosn zaig neg zaigaar soilno. muriin ehlel tugsugliin zaig avna
...
def main():
    ...
    print('normalize')
    test(normalize_text('Hello  World@3'), 'hello world 3')
